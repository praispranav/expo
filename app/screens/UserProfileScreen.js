...
import CommonStyles, { deviceHeight } from "../config/CommonStyles"
      ...
      <View style={CommonStyles.normalPage}>
        <GradientNavigationBar
          ...
          rightButtons={[
            {
              key: 1,
              buttonIcon: require("../assets/img/healer/settings.png"),
        ...
        <ScrollView style={CommonStyles.scrollView}>
          <View style={styles.avatarBox}>
            <Image
              source={require("../assets/img/person/avatar_2.png")}
          ...
          <View style={CommonStyles.itemWhiteBox}>
            ...
            <View style={styles.rowBottom}>
              <Item headerText="Height" content="198" unitText="cm" />
              <Item headerText="Weight" content="66" unitText="kg" />
              <Item
                headerText="Goal"
                content="78"
                unitText="%"
          ...
          <View style={styles.otherBox}>
            <ItemWithImage
              itemImg={require("../assets/img/healer/target.png")}
              iconWidth={26}
              iconHeight={26}
            ...
            />
            <ItemWithImage
              itemImg={require("../assets/img/healer/heart.png")}
              iconWidth={26}
              iconHeight={23.5}
            ...
            />
            <ItemWithImage
              itemImg={require("../assets/img/healer/umbrella.png")}
              iconWidth={22}
              iconHeight={25}
        ...
        <CustomTabBar navigation={this.props.navigation} isActive="tab4" />
      </View>
    )
  }
